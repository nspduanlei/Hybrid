...
public class HybridWebViewActivity extends HybridBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean navgation =
                getIntent().getBooleanExtra(HybridConstant.INTENT_EXTRA_KEY_HASNAVGATION, true);

        if (navgation) {
            mNavgationView.appendNavgation(NavgationView.Direct.LEFT, "", R.drawable.ic_back,
    ...
    public void finish() {
        super.finish();
        HybridParamAnimation animation = (HybridParamAnimation)
                getIntent().getSerializableExtra(HybridConstant.INTENT_EXTRA_KEY_ANIMATION);
    ...
    public void onEventMainThread(HybridParamShowHeader msg) {
        ...
        if (msg.animate) {
            mNavgationView.startAnimation(AnimationUtils.loadAnimation(this,
                    msg.display ? R.anim.hybrid_top_in : R.anim.hybrid_top_out));
        }
    }
