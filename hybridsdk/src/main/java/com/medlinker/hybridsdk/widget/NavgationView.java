...
public class NavgationView extends FrameLayout {
    ...
    public NavgationView appendNavgation(Direct direct, String label, String icon,
                                         OnClickListener clickListener) {
        appendInner(direct, label, icon, clickListener);
        return this;
    }

    public NavgationView appendNavgation(Direct direct, String label, int iconSource,
                                         OnClickListener clickListener) {
        appendInner(direct, label, iconSource, clickListener);
        return this;
    }

    private void appendInner(Direct direct, String label, Object icon,
                             OnClickListener clickListener) {
        ViewGroup viewGroup = (ViewGroup) mInflater.inflate(R.layout.hybrid_navgation_item,
                direct.equals(Direct.LEFT) ? mLeftView : mRightView, false);
