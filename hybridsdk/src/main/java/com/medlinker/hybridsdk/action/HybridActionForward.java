        ...
        switch (hybridParam.type) {
            ...
            case H5:
                if (HybridParamAnimation.NONE.equals(hybridParam.animate)) {
                    ...
                    bundle.putString(HybridConstant.INTENT_EXTRA_KEY_TOPAGE,
                            hybridParam.topage);
                    bundle.putSerializable(HybridConstant.INTENT_EXTRA_KEY_ANIMATION,
                            hybridParam.animate);
                    bundle.putBoolean(HybridConstant.INTENT_EXTRA_KEY_HASNAVGATION,
                            hybridParam.hasnavgation);
                    ActivityUtil.toSimpleActivity(webView.getContext(),
                            HybridWebViewActivity.class, hybridParam.animate, bundle);
                }
                break;
        }
    }
